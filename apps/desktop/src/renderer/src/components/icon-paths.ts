/**
 * Arlo AI action glyphs (design system components/icons): 24px box, 2px stroke,
 * round caps and joins, Feather geometry. Paths are copied verbatim from the
 * design-system bundle; add new glyphs there first.
 */
const ICON_PATHS = {
