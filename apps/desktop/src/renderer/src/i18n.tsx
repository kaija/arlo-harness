...
const messages = {
  en: {
    ...
    'settings.languageDescription': 'Use this language throughout the interface. Changes apply immediately.',
    ...
    'main.orchestratorAloneDescription': 'Create a Persona so it can delegate tasks and keep working in the background.',
  ...
  'zh-TW': {
    ...
    'main.orchestratorAloneDescription': '建立 Persona 後，它就能拆解任務、派發工作，並在背景持續執行。',
  ...
  ja: {
    ...
    'main.orchestratorAloneDescription': 'Persona を作成すると、タスクの委任とバックグラウンド処理ができます。',
